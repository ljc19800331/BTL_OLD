...
class Feature3d:
    ...
    def __init__(self):
        self.color_name = '/home/maguangshen/PycharmProjects/BTL/open5d/data/color.png'
        self.tex_name = '/home/maguangshen/PycharmProjects/BTL/open5d/data/tex.csv'
        self.vtx_name = '/home/maguangshen/PycharmProjects/BTL/open5d/data/vtx.csv'
    ...
    def ColorPc(self, idx_region, idx_target):
        ...
        filename = '/home/maguangshen/PycharmProjects/BTL/open5d/points.vtp'
...
def Show_color_pc(points, color):

    # This function aims to show the color and vertex vectors
    # points: numpy N by 3
    # color: numpy N by 3
